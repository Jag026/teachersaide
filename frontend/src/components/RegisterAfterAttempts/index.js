...
function RegisterAfterAttempts() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      ...
      <h2 className="mt-6 text-center text-2xl font-bold tracking-tight text-gray-900">Create An Account To Keep Using TeachersAIde</h2>
...
export default RegisterAfterAttempts;