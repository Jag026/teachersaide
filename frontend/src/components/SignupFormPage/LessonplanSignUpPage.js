...
function LessonplanSignUpPage() {
  ...
  return (
    <div className="m-10 flex flex-col">
      ...
      <form onSubmit={handleSubmit} className="mx-10 bg-white p-6 rounded-lg shadow-md flex flex-col sm:w-2/4 sm:max-w-[600px]">
        <ul>
...
export default LessonplanSignUpPage;